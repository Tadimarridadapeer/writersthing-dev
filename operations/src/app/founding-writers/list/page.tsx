        ...
        <table className="w-full text-left">
          <thead className="bg-zinc-50 border-b border-zinc-100">
            <tr>
              ...
              <th className="px-6 py-4 text-[9px] font-black uppercase tracking-widest text-zinc-500">Date</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
                ...
                <tr key={writer.id} className="border-b border-zinc-50 hover:bg-zinc-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`text-[9px] font-bold uppercase tracking-widest px-2 py-1 rounded ${
                      ...
                      writer.status === 'Pending' || writer.status === 'Invited' ? 'bg-amber-50 text-amber-700' :
                      writer.status === 'Inactive' ? 'bg-red-50 text-red-700' :
