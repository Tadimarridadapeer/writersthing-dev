...
export default function ManuscriptDetail() {
  ...
  useEffect(() => {
    const channel = supabase
      .channel(`manuscript-reviews-${params.id}`)
      .on(
        "postgres_changes",
  ...
  const fetchBookData = async () => {
    try {
      ...
      if (user && bookData && bookData.authors?.user_id) {
      ...
      <div className="flex-grow flex items-center justify-center pt-6 pb-20 px-8 relative">
        ...
        <div className="unified-axis w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            {/* Left: Book Cover - Scaled and Refined */}
            <div className="lg:col-span-5 flex justify-center lg:justify-start">
              ...
              >
                <img 
                  src={book.cover_url || "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?auto=format&fit=crop&q=80&w=800"} 
                  alt={book.title} 
            ...
            {/* Right: Info Section - Balanced Typography */}
            <div className="lg:col-span-7">
              ...
              >
                ...
                <div className="flex items-center gap-6 mb-10 pb-8 border-b border-zinc-100">
                  <p className="text-lg font-medium italic text-zinc-400">by {book.authors?.users?.name || "Unknown"}</p>
                ...
                <div className="mt-20 pt-12 border-t border-zinc-100 flex items-center gap-8">
                  <div className="w-20 h-20 bg-zinc-100 rounded-full overflow-hidden grayscale">
                    <img src={book.authors?.users?.avatar_url || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200"} alt={book.authors?.users?.name} />
                  </div>
                  <div className="flex-grow">
                    <h3 className="text-xl font-heading font-black uppercase tracking-tight">{book.authors?.users?.name}</h3>
                    <p className="text-xs text-zinc-400 font-medium italic mb-4">{book.authors?.bio || book.authors?.users?.bio || "Author of digital manuscripts"}</p>
                    <button 
