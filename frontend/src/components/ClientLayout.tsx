...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const showFooter = pathname !== "/login" && pathname !== "/signup" && pathname !== "/onboarding" && !pathname.startsWith("/book/");
  ...
  return (
    <>
      ...
      {showFooter && (
        <footer className="border-t border-zinc-100 dark:border-zinc-900 pt-8 pb-8 mt-6 md:pt-12 md:pb-12 md:mt-10">
        <div className="unified-axis">
          <div className="flex flex-col gap-8 mb-8 md:mb-12">
            <div className="mb-2">
              <span className="font-heading font-black text-2xl uppercase tracking-tighter italic block mb-4">Writersthing</span>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8">
              <div>
                <h4 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4 md:mb-6">Platform</h4>
                <ul className="flex flex-col gap-3 md:gap-4 text-xs md:text-sm font-medium text-zinc-500">
              ...
              <div>
                <h4 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4 md:mb-6">Company</h4>
                <ul className="flex flex-col gap-3 md:gap-4 text-xs md:text-sm font-medium text-zinc-500">
              ...
              <div>
                <h4 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4 md:mb-6">Connect</h4>
                <ul className="flex flex-col gap-3 md:gap-4 text-xs md:text-sm font-medium text-zinc-500">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-zinc-100 dark:border-zinc-900 gap-6">
            <p className="text-zinc-500 text-xs font-medium italic text-center md:text-left">© 2026 Writersthing. Built for the unknown.</p>
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">
