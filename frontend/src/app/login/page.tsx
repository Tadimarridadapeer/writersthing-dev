...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Note: signInWithOAuth automatically redirects the browser to Google
    } catch (err: any) {
        ...
        >
          ...
          <footer className="mt-8 pt-6 border-t border-zinc-50 flex flex-col items-center gap-4 w-full">
            ...
            <div className="flex items-center gap-4 w-full my-2">
              ...
              <span className="text-[9px] font-black uppercase tracking-widest text-zinc-300">Or continue with</span>
              <div className="h-px flex-grow bg-zinc-100" />
            </div>
            ...
            <button
              ...
              className="w-full bg-white text-zinc-900 border border-zinc-200 py-4 px-6 text-xs font-black uppercase tracking-widest hover:border-black hover:bg-zinc-50 transition-all flex items-center justify-center gap-3 shadow-sm disabled:opacity-50 cursor-pointer"
            >
