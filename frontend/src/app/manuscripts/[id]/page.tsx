            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                <div className="flex items-center gap-6 mb-10 pb-8 border-b border-zinc-100">
                  <p className="text-lg font-medium italic text-zinc-400">by {book.authors?.name || "Unknown"}</p>
                ...
                <div className="mt-20 pt-12 border-t border-zinc-100 flex items-center gap-8">
                  <div className="w-20 h-20 bg-zinc-100 rounded-full overflow-hidden grayscale">
                    <img src={book.authors?.avatar_url || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200"} alt={book.authors?.name} />
                  </div>
                  <div className="flex-grow">
                    <h3 className="text-xl font-heading font-black uppercase tracking-tight">{book.authors?.name}</h3>
                    <p className="text-xs text-zinc-400 font-medium italic mb-4">{book.authors?.bio || "Author of digital manuscripts"}</p>
                    <button 
